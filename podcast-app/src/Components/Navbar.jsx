...
const Navbar = () => {
  ...
  // Function to handle showing all podcasts (resetting filters)
  const handleShowAllClick = () => {
    setShowFavorites(false);
  };

  // Function to format date (assuming you have it implemented)
  const formatDate = (date) => {
    // Your date formatting logic here
  };

  // Function to handle poster expand/collapse (assuming you have it implemented)
  const toggleExpand = (posterId) => {
    // Your toggle expand logic here
  };
